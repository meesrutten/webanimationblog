  ...
  <footer className="bg-black-300 w-full py-6 px-4 mt-32 ">
    ...
    <div className="flex flex-col items-center justify-between my-4 px-4 max-w-xl mx-auto">
      <div className="flex items-center mb-5">
        ...
        <a href="https://www.linkedin.com/in/mees-rutten-52851491/">
          <svg
        ...
        <a href="https://twitter.com/meesrttn">
          <svg
            className="h-6 w-6 fill-current text-blue-600 mr-6"
            viewBox="0 0 512 512"
          >
      ...
      <p className="inline text-black-500">
        ...
        <a
          ...
          href="https://mohammedmulazada.com/"
          className="mx-1"
        >
          <strong>@moniac</strong>
        </a>{' '}
        for sharing this template!
      </p>

      <p className="inline-flex justify-center items-end text-black-500">
        by <strong className="mx-1">Mees Rutten</strong> @{' '}
        <a
          target="_blank"
          rel="noopener noreferrer"
